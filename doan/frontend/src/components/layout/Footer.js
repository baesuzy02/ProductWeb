            ...
            <div className="row">
              <div className="col-lg-5 col-md-6 col-12">
                ...
                <div className="single-footer about">
                  ...
                  <p className="text">Website bán hàng trực tuyến của Hưng Thành Store, hỗ trợ 24/7 cùng nhiều ưu đẫi hấp dẫn. Luôn luôn cập nhật mới nhiều sản phẩm.</p>
              ...
              <div className="col-lg-3 col-md-6 col-12">
                ...
                <div className="single-footer social">
                  ...
                  <div className="contact">
                    <ul>
                      <li>17 Phạm Cự Lượng</li>
                      <li>Nhóm 5</li>
                      <li>HungThanh@tltore.com</li>
                      <li>+012 3456 7890</li>
                    </ul>
                  </div>
                  {/* End Single Widget */}
